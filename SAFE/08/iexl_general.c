...
w32             *aReg;                          /* aReg=reg+8 : address
						   registers */
#else
#warning delete no NEW_AREG bit
w32      *g_reg;
#endif
