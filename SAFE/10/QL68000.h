...
#ifdef QM_BIG_ENDIAN
	static inline ruw16 q2hw(uw16 val) { return val; }
	static inline ruw32 q2hl(uw32 val) { return val; }
	static inline ruw16 h2qw(uw16 v) { return v; }
	static inline ruw32 h2ql(uw32 v) { return v; }

	#if 0 /* turns out that macros are till faster than inline */
		static inline void  _ww_(uw16 *addr, w16 d) { *(uw16*)addr=d; }
		static inline uw16 _rl_(uw16 *addr) { return *addr; }
	#else
