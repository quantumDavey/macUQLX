...
//	---------------------------------------------------------------------------------------------
	...
	SetTable(instbl, syntbl, "1010101010100000", LR InitROM, "ROMINI", 0xF000, 0xF000 ); // 0xaaa0 
	SetTable(instbl, syntbl, "1010101010100001", LR MdvIO, "MDVIO", 0xF000, 0xF000 ); // 0xaaa1 
	SetTable(instbl, syntbl, "1010101010100010", LR MdvOpen, "MDVO", 0xF000, 0xF000 ); // 0xaaa2 
	SetTable(instbl, syntbl, "1010101010100011", LR MdvClose, "MDVC", 0xF000, 0xF000 ); // 0xaaa3 
	SetTable(instbl, syntbl, "1010101010100100", LR MdvSlaving, "MDVSL", 0xF000, 0xF000 ); // 0xaaa4 
	SetTable(instbl, syntbl, "1010101010100101", LR MdvFormat, "MDVFO", 0xF000, 0xF000 ); // 0xaaa5 
	SetTable(instbl, syntbl, "1010101010100110", LR SerIO, "OSERIO", 0xF000, 0xF000 ); // 0xaaa6 
	SetTable(instbl, syntbl, "1010101010100111", LR SerOpen, "OSERO", 0xF000, 0xF000 ); // 0xaaa7 
	SetTable(instbl, syntbl, "1010101010101000", LR SerClose, "OSERC", 0xF000, 0xF000 ); // 0xaaa8 
	SetTable(instbl, syntbl, "1010101010101001", LR SchedulerCmd, "SCHED", 0xF000, 0xF000 ); // 0xaaa9 
	SetTable(instbl, syntbl, "1010101010101010", LR DrvIO, "DEVIO", 0xF000, 0xF000 ); // 0xaaaa 
	SetTable(instbl, syntbl, "1010101010101011", LR DrvOpen, "DEVO", 0xF000, 0xF000 ); // 0xaaab 
	SetTable(instbl, syntbl, "1010101010101100", LR DrvClose, "DEVC", 0xF000, 0xF000 ); // 0xaaac 
	SetTable(instbl, syntbl, "1010101010101101", LR KbdCmd, "MIPC", 0xF000, 0xF000 ); // 0xaaad 
	SetTable(instbl, syntbl, "1010101010101110", LR PollCmd, "POLL", 0xF000, 0xF000 ); // 0xaaae 
	SetTable(instbl, syntbl, "1010101010101111", LR KBencCmd, "KBENC", 0xF000, 0xF000 ); // 0xaaaf 
	SetTable(instbl, syntbl, "1010101010110000", LR BASEXTCmd, "BASXT", 0xF000, 0xF000 ); // 0xaab0 
	SetTable(instbl, syntbl, "1010101010110001", LR devpefio_cmd, "DPF", 0xF000, 0xF000 ); // 0xaab1 
	SetTable(instbl, syntbl, "1010101010110010", LR devpefo_cmd, "DPEFO", 0xF000, 0xF000 ); // 0xaab2 
	SetTable(instbl, syntbl, "1010110111000000", LR UseIPC, "IPC", 0xF000, 0xF000 ); // 0xadc0 
	SetTable(instbl, syntbl, "1010110111000001", LR ReadIPC, "IPCR", 0xF000, 0xF000 ); // 0xadc1 
	SetTable(instbl, syntbl, "1010110111000010", LR WriteIPC, "IPCW", 0xF000, 0xF000 ); // 0xadc2 
	SetTable(instbl, syntbl, "1010110111000111", LR FastStartup, "FSTART", 0xF000, 0xF000 ); // 0xadc7 
	SetTable(instbl, syntbl, "1010110111001000", LR QL_KeyTrans, "KYTRNS", 0xF000, 0xF000 ); // 0xadc8 
