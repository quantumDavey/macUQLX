...
{   
	...
	SetTable(instbl, syntbl, "0000000000xxxxxx", LR ori_b,			"ori.b",	0xE100,	2x003F );
	SetTable(instbl, syntbl, "0000000000111100", LR ori_to_ccr,		"ori",		0xE100,	0xF004 );
	SetTable(instbl, syntbl, "0000000001xxxxxx", LR ori_w,			"ori.w",	0xE200,	2x003F );
	SetTable(instbl, syntbl, "0000000001111100", LR ori_to_sr,		"ori",		0xE200,	0xF005 );
	SetTable(instbl, syntbl, "0000000010xxxxxx", LR ori_l,			"ori.l",	0xE300,	2x003F );
	SetTable(instbl, syntbl, "0000xxx100xxxxxx", LR btst_d,			"btst",		0x2E00,	6x003F );
	SetTable(instbl, syntbl, "0000xxx101xxxxxx", LR bchg_d,			"bchg",		0x2E00,	2x003F );
	SetTable(instbl, syntbl, "0000xxx110xxxxxx", LR bclr_d,			"bclr",		0x2E00,	2x003F );
	SetTable(instbl, syntbl, "0000xxx111xxxxxx", LR bset_d,			"bset",		0x2E00,	2x003F );
	...
	SetTable(instbl, syntbl, "0000001000xxxxxx", LR andi_b,			"andi.b",	0xE100,	2x003F );
	SetTable(instbl, syntbl, "0000001001xxxxxx", LR andi_w,			"andi.w",	0xE200,	2x003F );
	SetTable(instbl, syntbl, "0000001010xxxxxx", LR andi_l,			"andi.l",	0xE300,	2x003F );
	...
	SetTable(instbl, syntbl, "0000010000xxxxxx", LR subi_b,			"subi.b",	0xE100,	3x003F );
	SetTable(instbl, syntbl, "0000010001xxxxxx", LR subi_w,			"subi.w",	0xE200,	3x003F );
	SetTable(instbl, syntbl, "0000010010xxxxxx", LR subi_l,			"subi.l",	0xE300,	3x003F );
	SetTable(instbl, syntbl, "0000011000xxxxxx", LR addi_b,			"addi.b",	0xE100,	2x003F );
	SetTable(instbl, syntbl, "0000011001xxxxxx", LR addi_w,			"addi.w",	0xE200,	2x003F );
	SetTable(instbl, syntbl, "0000011010xxxxxx", LR addi_l,			"addi.l",	0xE300,	2x003F );
	SetTable(instbl, syntbl, "0000100000xxxxxx", LR btst_s,			"btst.s",	0xE100,	6x003F );
	SetTable(instbl, syntbl, "0000100001xxxxxx", LR bchg_s,			"bchg.s",	0xE100,	2x003F );
	SetTable(instbl, syntbl, "0000100010xxxxxx", LR bclr_s,			"bclr.s",	0xE100,	2x003F );
	SetTable(instbl, syntbl, "0000100011xxxxxx", LR bset_s,			"bset.s",	0xE100,	2x003F );
	SetTable(instbl, syntbl, "0000101000xxxxxx", LR eori_b,			"eori.b",	0xE100,	2x003F );
	SetTable(instbl, syntbl, "0000101001xxxxxx", LR eori_w,			"eori.w",	0xE200,	2x003F );
	SetTable(instbl, syntbl, "0000101010xxxxxx", LR eori_l,			"eori.l",	0xE300,	2x003F );
	...
	SetTable(instbl, syntbl, "0000110000xxxxxx", LR cmpi_b,			"cmpi.b",	0xE100,	6x003F );
	SetTable(instbl, syntbl, "0000110001xxxxxx", LR cmpi_w,			"cmpi.w",	0xE200,	6x003F );
	SetTable(instbl, syntbl, "0000110010xxxxxx", LR cmpi_l,			"cmpi.l",	0xE300,	6x003F );
	SetTable(instbl, syntbl, "0001xxxxxxxxxxxx", LR move_b,			"move.b",	0x003F,	8x1FC0 );
	SetTable(instbl, syntbl, "0001xxxxxx000xxx", LR move_b_from_dn,	"move.b",	0x2007,	8x1FC0 );
	SetTable(instbl, syntbl, "0001xxx000xxxxxx", LR move_b_to_dn,	"move.b",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "0001xxx000000xxx", LR move_b_reg,		"move.b",	0x2007,	0x2E00 );
	SetTable(instbl, syntbl, "0010xxxxxxxxxxxx", LR move_l,			"move.l",	0x003F,	8x1FC0 );
	SetTable(instbl, syntbl, "0010xxxxxx000xxx", LR move_l_from_dn,	"move.l",	0x2007,	8x1FC0 );
	SetTable(instbl, syntbl, "0010xxx000xxxxxx", LR move_l_to_dn,	"move.l",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "0010xxx000000xxx", LR move_l_reg,		"move.l",	0x2007,	0x2E00 );
	SetTable(instbl, syntbl, "0010xxx001xxxxxx", LR movea_l,		"movea.l",	0x003F,	0x3E00 );
	SetTable(instbl, syntbl, "0010xxx001001xxx", LR movea_l_an,		"movea.l",	0x3007,	0x3E00 );
	SetTable(instbl, syntbl, "0011xxxxxxxxxxxx", LR move_w,			"move.w",	0x003F,	8x1FC0 );
	SetTable(instbl, syntbl, "0011xxxxxx000xxx", LR move_w_from_dn,	"move.w",	0x2007,	8x1FC0 );
	SetTable(instbl, syntbl, "0011xxx000xxxxxx", LR move_w_to_dn,	"move.w",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "0011xxx000000xxx", LR move_w_reg,		"move.w",	0x2007,	0x2E00 );
	SetTable(instbl, syntbl, "0011xxx001xxxxxx", LR movea_w,		"movea.w",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "0100000000xxxxxx", LR negx_b,			"negx.b",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100000001xxxxxx", LR negx_w,			"negx.w",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100000010xxxxxx", LR negx_l,			"negx.l",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100000011xxxxxx", LR move_from_sr,	"move",		0xF005,	2x003F );
	SetTable(instbl, syntbl, "0100xxx110xxxxxx", LR chk,			"chk.w",	4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "0100xxx111xxxxxx", LR lea,			"lea",		7x003F,	0x2E00 );
	SetTable(instbl, syntbl, "0100001000xxxxxx", LR clr_b,			"clr.b",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100001001xxxxxx", LR clr_w,			"clr.w",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100001010xxxxxx", LR clr_l,			"clr.l",	2x003F,	0xF000 );

//	---------------------------------------------------------------------------------------------
//	SetTable(instbl, syntbl, "0100001011xxxxxx", LR move_from_ccr,	"move",		0xF004,	2x003F );
//	---------------------------------------------------------------------------------------------

	SetTable(instbl, syntbl, "0100010000xxxxxx", LR neg_b,			"neg.b",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100010001xxxxxx", LR neg_w,			"neg.w",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100010010xxxxxx", LR neg_l,			"neg.l",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100010011xxxxxx", LR move_to_ccr,	"move",		4x003F,	0xF004 );
	SetTable(instbl, syntbl, "0100011000xxxxxx", LR not_b,			"not.b",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100011001xxxxxx", LR not_w,			"not.w",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100011010xxxxxx", LR not_l,			"not.l",	2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100011011xxxxxx", LR move_to_sr,		"move",		4x003F,	0xF005 );
	SetTable(instbl, syntbl, "0100100000xxxxxx", LR nbcd,			"nbcd",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100100001xxxxxx", LR pea,			"pea",		7x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100100001000xxx", LR swap,			"swap",		0x2007,	0xF000 );
	SetTable(instbl, syntbl, "0100100010xxxxxx", LR movem_save_w,	"movem.w",	0xF900,	9x003F );
	SetTable(instbl, syntbl, "0100100010000xxx", LR ext_w,			"ext.w",	0x2007,	0xF000 );
	SetTable(instbl, syntbl, "0100100011xxxxxx", LR movem_save_l,	"movem.l",	0xF900,	9x003F );
	SetTable(instbl, syntbl, "0100100011000xxx", LR ext_l,			"ext.l",	0x2007,	0xF000 );
	SetTable(instbl, syntbl, "0100101000xxxxxx", LR tst_b,			"tst.b",	6x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100101001xxxxxx", LR tst_w,			"tst.w",	6x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100101010xxxxxx", LR tst_l,			"tst.l",	6x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100101011xxxxxx", LR tas,			"tas",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100101011111100", LR illegal,		"illegal",	0xF000,	0xF000 );
	SetTable(instbl, syntbl, "0100110010xxxxxx", LR movem_load_w,	"movem.w",	Ax003F,	0xF900 );
	SetTable(instbl, syntbl, "0100110011xxxxxx", LR movem_load_l,	"movem.l",	Ax003F,	0xF900 );
...
//	---------------------------------------------------------------------------------------------
	...
	SetTable(instbl, syntbl, "0100111010xxxxxx", LR jsr,			"jsr",		7x003F,	0xF000 );
	SetTable(instbl, syntbl, "0100111010111010", LR jsr_displ,		"jsr",		0x8000,	0xF000 );
	SetTable(instbl, syntbl, "0100111011xxxxxx", LR jmp,			"jmp",		7x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101xxx000xxxxxx", LR addq_b,			"addq.b",	0xAE00,	3x003F );
	SetTable(instbl, syntbl, "0101xxx001xxxxxx", LR addq_w,			"addq.w",	0xAE00,	3x003F );
	SetTable(instbl, syntbl, "0101xxx010xxxxxx", LR addq_l,			"addq.l",	0xAE00,	3x003F );
	...
	SetTable(instbl, syntbl, "0101xxxx11xxxxxx", LR scc,			"sCC",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101000011xxxxxx", LR st,				"st",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101000111xxxxxx", LR sf,				"sf",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101001011xxxxxx", LR scc,			"shi",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101001111xxxxxx", LR scc,			"sls",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101010011xxxxxx", LR scc,			"scc",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101010111xxxxxx", LR scc,			"scs",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101011011xxxxxx", LR scc,			"sne",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101011111xxxxxx", LR scc,			"seq",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101100011xxxxxx", LR scc,			"svc",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101100111xxxxxx", LR scc,			"svs",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101101011xxxxxx", LR scc,			"spl",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101101111xxxxxx", LR scc,			"smi",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101110011xxxxxx", LR scc,			"sge",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101110111xxxxxx", LR scc,			"slt",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101111011xxxxxx", LR scc,			"sgt",		2x003F,	0xF000 );
	SetTable(instbl, syntbl, "0101111111xxxxxx", LR scc,			"sle",		2x003F,	0xF000 );
	...
	SetTable(instbl, syntbl, "0101xxx100xxxxxx", LR subq_b,			"subq.b",	0xAE00,	3x003F );
	SetTable(instbl, syntbl, "0101xxx101xxxxxx", LR subq_w,			"subq.w",	0xAE00,	3x003F );
	SetTable(instbl, syntbl, "0101xxx110xxxxxx", LR subq_l,			"subq.l",	0xAE00,	3x003F );
	...
	SetTable(instbl, syntbl, "1000xxx000xxxxxx", LR or_b_dn,		"or.b",		4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1000xxx001xxxxxx", LR or_w_dn,		"or.w",		4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1000xxx010xxxxxx", LR or_l_dn,		"or.l",		4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1000xxx100xxxxxx", LR or_b_ea,		"or.b",		0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1000xxx101xxxxxx", LR or_w_ea,		"or.w",		0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1000xxx110xxxxxx", LR or_l_ea,		"or.l",		0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1000xxx011xxxxxx", LR divu,			"divu.w",	4x003F,	0x2E00 );
	...
	SetTable(instbl, syntbl, "1000xxx111xxxxxx", LR divs,			"divs.w",	4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1001xxx000xxxxxx", LR sub_b_dn,		"sub.b",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1001xxx001xxxxxx", LR sub_w_dn,		"sub.w",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1001xxx010xxxxxx", LR sub_l_dn,		"sub.l",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1001xxx100xxxxxx", LR sub_b_ea,		"sub.b",	0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1001xxx101xxxxxx", LR sub_w_ea,		"sub.w",	0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1001xxx110xxxxxx", LR sub_l_ea,		"sub.l",	0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1001xxx011xxxxxx", LR sub_w_an,		"suba.w",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1001xxx111xxxxxx", LR sub_l_an,		"suba.l",	0x003F,	0x2E00 );
	...
	SetTable(instbl, syntbl, "1011xxx000xxxxxx", LR cmp_b,			"cmp.b",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1011xxx001xxxxxx", LR cmp_w,			"cmp.w", 	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1011xxx010xxxxxx", LR cmp_l,			"cmp.l", 	0x003F,	0x2E00 );
	...
	SetTable(instbl, syntbl, "1011xxx011xxxxxx", LR cmpa_w,			"cmpa.w",	0x003F,	0x3E00 );
	SetTable(instbl, syntbl, "1011xxx111xxxxxx", LR cmpa_l,			"cmpa.l",	0x003F,	0x3E00 );
	SetTable(instbl, syntbl, "1011xxx111001xxx", LR cmpa_l_an,		"cmpa.l",	0x3007,	0x3E00 );
	SetTable(instbl, syntbl, "1011xxx100xxxxxx", LR eor_b,			"eor.b",	0x2E00,	2x003F );
	SetTable(instbl, syntbl, "1011xxx101xxxxxx", LR eor_w,			"eor.w",	0x2E00,	2x003F );
	SetTable(instbl, syntbl, "1011xxx110xxxxxx", LR eor_l,			"eor.l",	0x2E00,	2x003F );
	...
	SetTable(instbl, syntbl, "1100xxx000xxxxxx", LR and_b_dn,		"and.b",	4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1100xxx001xxxxxx", LR and_w_dn,		"and.w",	4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1100xxx010xxxxxx", LR and_l_dn,		"and.l",	4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1100xxx010000xxx", LR and_l_dn_dn,	"and.l",	0x2007,	0x2E00 );
	SetTable(instbl, syntbl, "1100xxx100xxxxxx", LR and_b_ea,		"and.b",	0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1100xxx101xxxxxx", LR and_w_ea,		"and.w",	0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1100xxx110xxxxxx", LR and_l_ea,		"and.l",	0x2E00,	5x003F );
	SetTable(instbl, syntbl, "1100xxx011xxxxxx", LR mulu,			"mulu.w",	4x003F,	0x2E00 );
	...
	SetTable(instbl, syntbl, "1100xxx111xxxxxx", LR muls,			"muls.w",	4x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1101xxx000xxxxxx", LR add_b_dn,		"add.b",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1101xxx001xxxxxx", LR add_w_dn,		"add.w",	0x003F,	0x2E00 );
	SetTable(instbl, syntbl, "1101xxx010xxxxxx", LR add_l_dn,		"add.l",	0x003F,	0x2E00 );
	...
	SetTable(instbl, syntbl, "1101xxx100xxxxxx", LR add_b_ea,		"add.b",	0x2E00,	1x003F );
	SetTable(instbl, syntbl, "1101xxx101xxxxxx", LR add_w_ea,		"add.w",	0x2E00,	1x003F );
	SetTable(instbl, syntbl, "1101xxx110xxxxxx", LR add_l_ea,		"add.l",	0x2E00,	1x003F );
	SetTable(instbl, syntbl, "1101xxx011xxxxxx", LR add_w_an,		"adda.w",	0x003F,	0x3E00 );
	SetTable(instbl, syntbl, "1101xxx111xxxxxx", LR add_l_an,		"adda.l",	0x003F,	0x3E00 );
	...
	SetTable(instbl, syntbl, "1110000011xxxxxx", LR asr_m,			"asr",		5x003F,	0xF000 );
	SetTable(instbl, syntbl, "1110000111xxxxxx", LR asl_m,			"asl",		5x003F,	0xF000 );
	SetTable(instbl, syntbl, "1110001011xxxxxx", LR lsr_m,			"lsr",		5x003F,	0xF000 );
	SetTable(instbl, syntbl, "1110001111xxxxxx", LR lsl_m,			"lsl",		5x003F,	0xF000 );
	SetTable(instbl, syntbl, "1110010011xxxxxx", LR roxr_m,			"roxr",		5x003F,	0xF000 );
	SetTable(instbl, syntbl, "1110010111xxxxxx", LR roxl_m,			"roxl",		5x003F,	0xF000 );
	SetTable(instbl, syntbl, "1110011011xxxxxx", LR ror_m,			"ror",		5x003F,	0xF000 );
	SetTable(instbl, syntbl, "1110011111xxxxxx", LR rol_m,			"rol",		5x003F,	0xF000 );
